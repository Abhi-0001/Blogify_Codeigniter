...
<head>
  ...
  <title>Admin Blog Panel | Blogify</title>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="<?php echo base_url() ?>public/admin/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Admin Blog Panel</span>
    </a>
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="#" class="nav-link active">
                  ...
                  <p class='text-capitalize'>add category</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="#" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p class='text-capitalize'>view category</p>
                </a>
              </li>
            </ul>
          </li>
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="#" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p class='text-capitalize'>Add article</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="#" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p class='text-capitalize'>View article</p>
                </a>
              </li>
            </ul>
          </li>
    ...
    <div class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body" style="height: 450px; display: flex; justify-content: center; align-items: center;">
                <h3 class="">Welcome to Blogify Admin Panel</h3>
              </div>
            </div>
          </div>
          <!-- /.col-md-6 -->
